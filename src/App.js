  ...
  addRecipe= ()=>{
    this.setState({
      ...
      switch(this.state.counter){
          case 1:{
            ingredientsArray = [new Ingredient("Tetovac",10)]
            this.setState({
              recipeOneIngredients:ingredientsArray
            })
            recept =  new Recipe("Pasulj","Mnogo dobar","https://www.recepti.com/img/recipe/19533-prebranac_zoom.jpg",this.state.recipeOneIngredients)
            break;
          }
          case 2:{
            ingredientsArray = [new Ingredient("Krompir",5)]
            this.setState({
              recipeTwoIngredients:ingredientsArray
            });
            recept = new Recipe("Musaka","Puna krompira i mesa","https://www.recepti.com/images/stories/kuvar/glavna-jela/00244-musaka-od-krompira.jpg")
            break;
          }
          case 3:{
            ingredientsArray = [new Ingredient("Pirinac",300)]
            this.setState({
              recipeThreeIngredients:ingredientsArray
            });
            recept = new Recipe("Pilav","Nema dalje","https://domacirecepti.net/wp-content/uploads/2015/04/pilav.jpg")
            break;
          }
          case 4:{
            ...
            recept = new Recipe("Giros","Potekao iz Grcke","https://coolinarika.azureedge.net/images/_variations/b/a/ba40f11749d8aea411bc53250d8fc24f_view_l.jpg?v=34")
            break;
          }
          case 5:{
            ...
            recept = new Recipe("Pile","Za sve ljubitelje mesa","https://lepaisrecna.rs/Picture/38297/jpeg/Saveti_iskusnih_domacica_6_saveta_za_najukusnije_peceno_pile_843874349")
            break;
          }
          case 6:{
            ingredientsArray = [new Ingredient("Testo",400)]
            this.setState({
              recipeSixIngredients:ingredientsArray
            });
            recept = new Recipe("Lazanje","Predobar dorucak","https://coolinarika.azureedge.net/images/_variations/9/4/94717ea3d6076022fee2861b51685fa9_view_l.jpg?v=3")
            break;
          }
          case 7:{
            ingredientsArray = [new Ingredient("Komadici mesa",300)]
            this.setState({
              recipeSevenIngredients:ingredientsArray
            });
            recept = new Recipe("Boranija","I nije nesto","https://coolinarika.azureedge.net/images/_variations/7/7/7786dd81755c5b5e267be39f3ead0e62_view_l.jpg?v=1")
            break;
          }
          default:{}
        }
